...
print("reading data...")
all_phase2 = pd.read_json("./real_data_gen/triplets/phase2.json", orient="index")
all_triplets = pd.read_json("./real_data_gen/triplets/no_comments/triplets.json", orient="index")
...
# Driver Code
for i in tqdm(range(len(common_projects_df)), desc="Calculating project similarity"):
    ...
    with pd.option_context("mode.chained_assignment", None):
        ...
        triplets_df = all_triplets[all_triplets["project"] == triplets_name]
